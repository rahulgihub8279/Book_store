  ...
  return (
    <div className="bg-zinc-900 min-h-screen px-4 sm:px-8 lg:px-12 py-6">
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="bg-zinc-950 rounded-lg p-4 flex flex-col lg:flex-row justify-center items-center w-full lg:w-1/2 gap-6">
          <img
            src={Data?.url}
            alt={Data?.title}
          ...
          {isLoggedIn && role === "user" && (
            <div className="flex flex-row lg:flex-col gap-6">
              ...
              <button className="bg-zinc-300 text-red-700 rounded-full p-3 text-2xl sm:text-3xl hover:bg-zinc-700 hover:scale-110 transition">
                <FaHeart />
              </button>
            </div>
          )}
